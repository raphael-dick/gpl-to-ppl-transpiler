...
for i in range(1, nsim + 1):
  ...
  results_i = { "mcmc": mcmc, "start": { "m_Rth_start": m_Rth_start, "sd_Rth_start": sd_Rth_start }, "Rth_MH": Rth_MH, "muRth_MH": muRth_MH, "sigmaRth_MH": sigmaRth_MH, "Rth_accept": Rth_accept, "theta_accept": theta_accept, "acc_rate_Rth": acc_rate_Rth, "acc_rate_theta": acc_rate_theta, "duration": dur }
